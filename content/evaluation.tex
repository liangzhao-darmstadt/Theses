...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=1,transform shape]
        \begin{groupplot}[
            ...
            \legend{Fixed-Point \booleanGMW w/o \simd, Fixed-Point \arithmeticGMW}
        \end{groupplot}
    \end{tikzpicture}\\
    \ref{UniversalLegend}
    \caption[Total runtime in microseconds for fixed-point arithmetic operations for the \booleanGMW (\BOOL)~\cite{goldreich1987play} and \arithmeticGMW protocol.]{Total runtime in microseconds (y-axis) for fixed-point arithmetic operations for the \booleanGMW (\BOOL)~\cite{goldreich1987play} and \arithmeticGMW protocol in WAN test encironments (cf.~\autoref{cha:evaluation}) with $2,3,5$ parties (x-axis). We take the average results over $10$ protocol runs. }
...
\begin{figure}[ht]
    ...
    \begin{tikzpicture}[scale=1,transform shape]
        \begin{groupplot}[
            ...
            \legend{Floating-Point \booleanGMW w/o \simd, Floating-Point \arithmeticGMW}
        \end{groupplot}
    \end{tikzpicture}\\
    \ref{UniversalLegend}
    \caption[Total runtime in microseconds for floating-point arithmetic operations for the \booleanGMW (\BOOL)~\cite{goldreich1987play} and \arithmeticGMW protocol.]{Total runtime in microseconds (y-axis) for floating-point arithmetic operations for the \booleanGMW (\BOOL)~\cite{goldreich1987play} and \arithmeticGMW protocol in WAN test encironments (cf.~\autoref{cha:evaluation}) with $2,3,5$ parties (x-axis). We take the average results over $10$ protocol runs. }
...
\section{Differentially Pirvate Mechanism Benchmarks}
...
\TODO{We encounter memory overflow when implement BGMW-based $M_{DGau}$, try to implement it in AGMW-based floating-point arithmetic}
